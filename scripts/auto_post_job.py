"""
Auto Post Job Script - Standalone Version
==========================================

Bản copy của: jobs/management/commands/auto_post_job.py

LƯU Ý: File này được copy ra đây để tiện quản lý.
       Để chạy, vẫn phải dùng lệnh Django:
       
       python manage.py auto_post_job --count 10

Không thể chạy trực tiếp file này (python scripts/auto_post_job.py) 
vì cần Django ORM để thao tác database.

Xem hướng dẫn chi tiết trong file: HUONG_DAN_SU_DUNG.txt
"""

# ============================================================
# NỘI DUNG GỐC - TỪ jobs/management/commands/auto_post_job.py
# ============================================================
